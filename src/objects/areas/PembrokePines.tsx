...
const PembrokePines = () => {
    ...
    PembrokePinesObject.nameForProjectFolders = "pembroke-pines";
    PembrokePinesObject.slogan = "Únase a Nosotros – Progrese con Nosotros";
    PembrokePinesObject.officialName = "Pembroke Pines";
