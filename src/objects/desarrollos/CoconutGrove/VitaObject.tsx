...
export default function Vita() {
    ...
    VitaObject.nameForProjectFolders = "vita-grove";
    VitaObject.traits = {
        residences: (
            <ul>
