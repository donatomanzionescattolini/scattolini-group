...
export default function PineRocklandEstates() {
    ...
    PinelandRocklandEstatesObject.nameForProjectFolders = "pine-rockland-estates";
    ...
    PinelandRocklandEstatesObject.building = {
        yearOfCompletion: 0,
        ...
        typeOfUnits: "",
        address: "7200 SW 73rd Ct, Miami, FL 33143"
    }
    ...
    PinelandRocklandEstatesObject.officialName = "Pine Rockland Estates";
