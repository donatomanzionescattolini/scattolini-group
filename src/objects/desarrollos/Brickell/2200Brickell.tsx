    ...
    _2200BrickellObject.caracteristicas = {
        ...
        residencias: <dl style={{textAlign: "justify"}}>
            ...
            <li>Pavimento cerámico de gran formato en toda la zona de estar
                y suelos de madera en los dormitorios
            </li>
            <li>Balcones totalmente alicatados con barandillas de vidrio con acceso desde
                la sala de estar y el dormitorio principal de cada residencia
            </li>
            ...
            <ul style={{textAlign: "justify"}}><b style={{textAlign: 'left'}}>Brindemos Por Una Vida Bien Vivida</b>
                <p>Desde sus inicios, 2200 BRICKELL fue diseñado para brindar a los residentes una experiencia de vida
                    ...
                    style={{textAlign: 'left'}}>El hogar es donde está la armonía</b><br></br>Adoptando un enfoque
                ...
                <p>Abarcando cerca de un acre de pies cuadrados bañados por el sol, el exuberante paisaje de la azotea
                    ...
                    satisfacción cotidiana, la serenidad y tomar el sol a nuevas alturas.</p>
