...
export default function Lofty() {
    ...
    Lofty.nameForProjectFolders = "lofty";
    Lofty.officialName = "Lofty";
    Lofty.traits = {
        residences: (
            <ul>
                <br></br>
