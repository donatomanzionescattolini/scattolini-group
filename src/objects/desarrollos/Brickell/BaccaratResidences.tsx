...
export default function BaccaratResidences() {
    ...
    baccaratResidencesObject.video = <div className={"video-container container-fluid justify-content-center"}>
        <div style={{"padding": "56.25% 0 0 0", position: "relative"}}>
            <iframe
                src="https://player.vimeo.com/video/725808410?h=2dd1afbdd4&autoplay=1&loop=1&title=0&byline=0&portrait=0"
    ...
    baccaratResidencesObject.officialName = "Baccarat Residences";
